...
for i=1:length(names)
    ...
    save(char(newname),'-struct','f', 'bead_radius', 'want_filter', 'f_3dB_filter', 'rate', 'T', 'l', 'f_lim_up', 'f_lim_low', 'nb', 'slopes', 'Traps', 'remove_peaks', 'eta_x', 'kappa_x', 'gamma_x', 'D_x', 'eta_y', 'kappa_y', 'gamma_y', 'D_y');
    clear f;
end
